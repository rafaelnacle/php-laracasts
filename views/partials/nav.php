        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/about"
              ...
              Us</a>
            <a href="/notes"
              class="<?= urlIs('/about') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Notes</a>
            <a href="/contact"
  ...
  <div class="md:hidden" id="mobile-menu">
    ...
    <div class="border-t border-gray-700 pb-3 pt-4">
      ...
      <div class="mt-3 space-y-1 px-2">
        <a href="/" class="bg-gray-900 text-white block rounded-md px-3 py-2 text-sm font-medium"
          aria-current="page">Home</a>
        <a href="/about.php"
